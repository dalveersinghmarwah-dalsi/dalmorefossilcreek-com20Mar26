        ...
        <section ref={servicesRef.ref} className="py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Celebrations Card */}
              <div className={`scroll-trigger-bounce ${servicesRef.isInView ? 'in-view' : ''}`} style={{ animationDelay: '0s' }}>
                <Link href="/celebrations">
                  <div className="bg-white rounded-lg shadow-md hover-lift hover-glow p-8 cursor-pointer relative group overflow-hidden h-full transition-smooth">
                    ...
                    <h3 className="text-2xl font-serif font-bold mb-3 text-gray-900 group-hover:text-rose-600 transition-smooth">
                      Celebrations
                    </h3>
              ...
              <div className={`scroll-trigger-bounce ${servicesRef.isInView ? 'in-view' : ''}`} style={{ animationDelay: '0.1s' }}>
                <Link href="/corporate">
                  <div className="bg-white rounded-lg shadow-md hover-lift hover-glow p-8 cursor-pointer relative group overflow-hidden h-full transition-smooth">
                    <div className="absolute top-0 right-0 w-20 h-20 bg-rose-50 rounded-full -mr-10 -mt-10 group-hover:scale-150 transition-smooth-lg"></div>
                    <div className="w-12 h-12 bg-rose-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-rose-200 transition-smooth">
              ...
              {/* Receptions Card */}
              <div className={`scroll-trigger-bounce ${servicesRef.isInView ? 'in-view' : ''}`} style={{ animationDelay: '0.2s' }}>
                <Link href="/prices">
                  <div className="bg-white rounded-lg shadow-md hover-lift hover-glow p-8 cursor-pointer relative group overflow-hidden h-full transition-smooth">
                    <div className="absolute top-0 right-0 w-20 h-20 bg-rose-50 rounded-full -mr-10 -mt-10 group-hover:scale-150 transition-smooth-lg"></div>
                    <div className="w-12 h-12 bg-rose-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-rose-200 transition-smooth">
