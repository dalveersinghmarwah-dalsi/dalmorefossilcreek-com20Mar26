    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Link href="/celebrations">
                <div className="bg-white rounded-lg shadow-md hover-lift hover-glow p-8 cursor-pointer animate-fade-in-up animate-delay-100 relative group overflow-hidden">
              ...
              <Link href="/corporate">
                <div className="bg-white rounded-lg shadow-md hover-lift hover-glow p-8 cursor-pointer animate-fade-in-up animate-delay-200 relative group overflow-hidden">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-rose-50 rounded-full -mr-10 -mt-10 group-hover:scale-150 transition-smooth-lg"></div>
                  <div className="w-12 h-12 bg-rose-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-rose-200 transition-smooth">
              ...
              {/* Receptions Card */}
              <Link href="/prices">
                <div className="bg-white rounded-lg shadow-md hover-lift hover-glow p-8 cursor-pointer animate-fade-in-up animate-delay-300 relative group overflow-hidden">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-rose-50 rounded-full -mr-10 -mt-10 group-hover:scale-150 transition-smooth-lg"></div>
                  <div className="w-12 h-12 bg-rose-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-rose-200 transition-smooth">
        ...
        <section className="py-16 md:py-24 bg-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4 text-gray-900 text-center animate-fade-in-up">
              Venue Amenities
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {AMENITIES.slice(0, 6).map((amenity: any, index: number) => (
                <div
                  key={index}
                  className="p-6 border-2 border-gray-100 rounded-lg hover-lift hover-glow transition-smooth animate-fade-in-up group"
        ...
        {/* CTA Section */}
        <section className="py-16 md:py-24 bg-gradient-to-r from-rose-600 via-rose-600 to-rose-700 text-white relative overflow-hidden">
